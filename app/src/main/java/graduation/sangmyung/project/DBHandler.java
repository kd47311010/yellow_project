...
public class DBHandler {
    ...
    public void copyDB() {
        ...
        try {
            ...
            File file = new File("/data/data/graduation.sangmyung.project/files/");
            file.mkdir();
            fos = new FileOutputStream(
                    "/data/data/graduation.sangmyung.project/files/notice.txt");
            ...
            file = new File("/data/data/graduation.sangmyung.project/databases/");
            file.mkdir();
            fos = new FileOutputStream(
                    "/data/data/graduation.sangmyung.project/databases/"
                            + mNewestDBInfo);
    ...
    public void readDB() {
        ...
        SQLiteDatabase sqlDb = SQLiteDatabase.openDatabase(
                "/data/data/graduation.sangmyung.project/databases/" + mNewestDBInfo,
        ...
        if (mTheme.equals(PALACE)) {
            sqlStr = "select * from test where theme='편의점'";
        } else if (mTheme.equals(LANDSCAPE)) {
            sqlStr = "select * from test where theme='음식점'";
        } else if (mTheme.equals(SHOPPING)) {
            sqlStr = "select * from test where theme='카페'";
        } else if (mTheme.equals(CULTURE)) {
            sqlStr = "select * from test where theme='학교건물'";
        } else if (mTheme.equals(MUSEUM)) {
            sqlStr = "select * from test where theme='문구류'";
